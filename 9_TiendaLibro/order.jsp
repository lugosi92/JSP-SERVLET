...
<title>Pedido a la Librera MVC</title>
</head>
<body>
	<h2>Librera MVC</h2>
	<hr/>
	...
	<form name="AnyadirForm" action="shopping" method="POST">
		<input type="hidden" name="todo" value="add"> Ttulo: <select name=idLibro>
			<%
			// Scriptlet 1: Carga los libros en el select.
				for (int i = 0; i < practica.LibrosBD.tamanyo(); i++) {
					out.println("<option value=" + i + ">");
					out.println(practica.LibrosBD.getTitulo(i) + " | " + practica.LibrosBD.getAutor(i) + " | " + practica.LibrosBD.getPrecio(i));
					out.println("</option>");
				}
			%>
	...
	<table border="1" cellspacing="0" cellpadding="5">
		...
		// Scriptlet 3: Muestra los libros del carrito.
			...
			practica.ElementoPedido elementoPedido = cesta.get(i);
		%>
		<tr>
